...
## write first result data set to txt
write.table(data, "measurements_mean_std.txt",row.name=FALSE)
...
## write second result data set to txt
write.table(data3, "activity_subject_means.txt",row.name=FALSE)